      ...
      <section id="about" className="py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Tony Barnett was the founder of Falcon's Nest, and Earl Bunch 111 bought Falcon's Nest from him at age 24. Earl grew up next door to Tony and worked for him as a teenager. He's been working on chimneys his whole life, bringing more than 30 years of professional experience to every home we serve.
            </p>
            <p className="mt-4 text-muted-foreground">
